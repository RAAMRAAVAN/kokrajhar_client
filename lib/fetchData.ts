...
export const FetchFacilitiesData = [{
  ...
  "path": "Kokrajhar/Facilities/1.jpg",
  "Loader": "#0076bd",
  "color1": "#cbdae54",
  "color2": "#ced0d51",
  "order": 1
},
{
  ...
  "path": "Kokrajhar/Facilities/2.jpg",
  "Loader": "#0076bd",
  "color1": "#cbdae55",
  "color2": "#ced0d52"
},
...
// },
{
  ...
  "path": "Kokrajhar/Facilities/4.jpg",
  "Loader": "#0076bd",
  "color1": "#cbdae59",
  "color2": "#ced0d56"
},
{
  ...
  "path": "Kokrajhar/Facilities/6.jpg",
  "Loader": "#0076bd",
  "color1": "#cbdae54",
  "color2": "#ced0d2",
  "order": 19
...
// },
{
  ...
  "path": "Kokrajhar/Facilities/3.jpg",
  "Loader": "#0076bd",
  "color1": "#cbdae54",
  "color2": "#ced0d51",
  "order": 15
...
// },
{
  ...
  "path": "Kokrajhar/Facilities/8.jpg",
  "Loader": "#0076bd",
  "color1": "#cbdae67",
  "color2": "#ced0d64"
}]
...
export const FetchAboutUs = [
  {
    ...
    "HospitalID": 1,
    "title": "Who we are",
    "short_description": "Kokrajhar Cancer Centre – a unit of Assam Cancer Care Foundation (ACCF) - is located adjacent to Kokrajhar Medical College and Hospital (KMCH) at Kokrajhar. With its state-of-the-art infrastructure, the 44-bedded centre is equipped with advanced technology. The unit has a team of experienced Oncologists from reputed medical institutes and oncology-trained nurses to ensure best of treatment and care.",
    "read_more2": false,
    "description2": "Kokrajhar Cancer Centre – a unit of Assam Cancer Care Foundation (ACCF) - is located adjacent to Kokrajhar Medical College and Hospital (KMCH) at Kokrajhar. With its state-of-the-art infrastructure, the 44-bedded centre is equipped with advanced technology. The unit has a team of experienced Oncologists from reputed medical institutes and oncology-trained nurses to ensure best of treatment and care.",
    "description": "Kokrajhar Cancer Centre – a unit of Assam Cancer Care Foundation (ACCF) - is located adjacent to Kokrajhar Medical College and Hospital (KMCH) at Kokrajhar. With its state-of-the-art infrastructure, the 44-bedded centre is equipped with advanced technology. The unit has a team of experienced Oncologists from reputed medical institutes and oncology-trained nurses to ensure best of treatment and care.",
    "active": "Y",
    "path": "Kokrajhar/about/whoWeAre.jpg"
  },
  {
    "_id": "67f1623946886839f4f9b661",
    "HospitalID": 1,
    "title": "Key facilities",
    "short_description": "Radiation Therapy, Chemotherapy, CT Scan, MRI, X-Ray, Blood Storage Unit, Mammography, and laboratory services are a few of the facilities. The centralised helpdesk - DiNC (Digital Nerve Centre) connects the centre to the network of ACCF units in real time, for delivery of virtual care through effective and efficient communication. Appointments and cancer related queries can be done from the comfort of home through the helpdesk.",
    "read_more2": false,
    "description": "Radiation Therapy, Chemotherapy, CT Scan, MRI, X-Ray, Blood Storage Unit, Mammography, and laboratory services are a few of the facilities. The centralised helpdesk - DiNC (Digital Nerve Centre) connects the centre to the network of ACCF units in real time, for delivery of virtual care through effective and efficient communication. Appointments and cancer related queries can be done from the comfort of home through the helpdesk.",
    "active": "Y",
    "path": "Kokrajhar/about/keyfacilities.jpg"
  },
  {
    "_id": "67f163b746886839f4f9b662",
    "HospitalID": 1,
    "title": "How does the centre help?",
    "short_description": "Kokrajhar Cancer Centre is strategically located to cater to the needs of cancer patients in Kokrajhar, its neighbouring districts and adjacent states. Patients from neighbouring countries can also avail the services. The location of the centre has helped in reducing financial and emotional burdens of the local population, who otherwise would have travelled to state headquarters for treatment. The centre offers cashless treatment for patients under Central Government scheme – PMJAY (Ayushman Bharat Pradhan Mantri Jan Arogya Yojana) and ESIC.",
    "read_more2": false,
    "description": "Kokrajhar Cancer Centre is strategically located to cater to the needs of cancer patients in Kokrajhar, its neighbouring districts and adjacent states. Patients from neighbouring countries can also avail the services. The location of the centre has helped in reducing financial and emotional burdens of the local population, who otherwise would have travelled to state headquarters for treatment. The centre offers cashless treatment for patients under Central Government scheme – PMJAY (Ayushman Bharat Pradhan Mantri Jan Arogya Yojana) and ESIC.",
    "active": "Y",
    "path": "Kokrajhar/about/centre_help.jpg"
  }
]
...
export async function fetchNewsAndEvents2() {
  ...
  try {
    const response = await fetch(`https://barpetacancercentre.org/api/get-news-events-for-center`, {
      ...
      body: JSON.stringify({ ccode: "Kokrajhar" }),
      next: { revalidate: 900 },
      // cache: "no-store",
    });
